...
export const Footer = () => {
  return (
    <footer className="mt-20 flex justify-center border-t-3">
      <section className="m-8 mt-12 flex w-full flex-col justify-around gap-2 md:flex-row md:flex-wrap md:gap-8">
        <section>
          ...
          <p className="mb-5 w-3/4 text-gray-600 md:w-4/5 md:text-xl">
        ...
        <p className="mt-6 w-full border-t-1 border-gray-300 pt-6 text-center text-gray-500">
          © 2025 dotDAGENE
        </p>
      </section>
    </footer>
