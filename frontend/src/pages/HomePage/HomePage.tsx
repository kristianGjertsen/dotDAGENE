    ...
    <>
      ...
      <AppLayout>
        ...
        <div className="relative isolate">
          ...
          {/* All page content stays above the decorative line. Opaque cards hide
              the stroke where it passes underneath them, so the line appears to
              travel behind the layout rather than on top of it. */}
          <div className="relative z-10">
            ...
            <section className="px-6 py-20 sm:px-12 lg:px-20">
              ...
              >
                ...
                >
                  ...
                  andre gang av informatikkstudenter ved NTNU. Vi bygger videre på
            ...
            <section className="px-6 pt-10 pb-30 sm:px-12 lg:px-20">
              <div className="flex flex-col flex-wrap items-center gap-20">
                <div
                  className="home-scroll-reveal bg-dotbackground relative mx-auto max-w-5xl px-4 py-6"
                  data-journey-anchor
                  data-journey-x="1.08"
                  data-journey-y="0.5"
                >
                ...
                <section className="flex w-full flex-col items-stretch justify-center gap-x-4 gap-y-10">
                  ...
                  <div
                    className="home-scroll-reveal relative"
                    data-journey-anchor
                    data-journey-x="-0.08"
                    data-journey-y="0.5"
                  >
